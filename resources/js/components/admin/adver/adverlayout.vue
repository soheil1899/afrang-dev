    ...
    export default {
        ...
        methods: {
            loadpage(){
                ...
                axios.get('/admin/adv/layouts/create')
            ...
            del(id){
                Swal.fire({
                    ...
                    if (result.value) {
                        axios.delete('/admin/adv/layouts/'+id)
                            .then(function (response) {
                                that.loadpage();
                                Swal.fire(
            ...
            edit(id){
                ...
                axios.get('/admin/adv/layouts/'+id+'/edit')
                    .then(function (response) {
            ...
            save(){
                ...
                if(this.data.id!=null){
                    axios.put('/admin/adv/layouts/'+this.data.id,data)
                        .then(function (response) {
                            that.loadpage();
                        })
                        .catch((error) => {
                    ...
                    axios.post('/admin/adv/layouts',that.data)
                        .then(function (response) {
                            that.loadpage();
                        })
                        .catch((error) => {
