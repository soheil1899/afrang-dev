<template>
    <div>
        <div>
            <a class="btn btn-primary" v-text="$lang.store.add" href="/admin/VideoCenter/Class"></a>
        ...
        <table class="table margintop">
            ...
            <tr  v-for="item in listclass.data">
                ...
                <th>{{ item.name }}</th>
                <th>{{ item.date }}</th>
                <th>{{ item.to_porf.name }} {{ item.to_porf.to_prof[0].family }}</th>
                <th><a class="fa fa-check" v-bind:href="'/admin/VideoCenter/Lessons/'+item.id"></a></th>
                <th><a class="fa fa-edit" v-bind:href="'/admin/VideoCenter/Class/'+item.id"></a> </th>
                <th>         </th>
    ...
    export default {
        ...
        methods: {
            loadclass(){
                ...
                axios.post('/admin/VideoCenter/loadclass',this.data)
