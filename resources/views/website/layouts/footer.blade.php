    ...
    <div class="container">
        <div class="row m-0">
            ...
            <div class="col-12 col-md-5 col-lg-3 px-4">
                ...
                <a href="{{ \App\setting::first()->instagram }}">
                    <div class="row m-0">
                        <div class="col-3 p-0">
                            <div class="py-2 text-center mb-2 mx-auto pointer footersocial">
...
<div class="py-3 footerbottom" dir="ltr">
    <div class="row mx-2 mx-md-5">
        <div class="col-12 col-lg-6">
            <p class="m-0 footersocialtext text-center text-md-left px-0 px-md-2">&copy; 2019 {{ \App\setting::first()->websitename }}. All rights
                reserved.</p>
        </div>
