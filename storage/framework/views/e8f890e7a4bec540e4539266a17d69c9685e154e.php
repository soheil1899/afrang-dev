                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="card shadow mb-4">
                            ...
                            <!-- Card Body -->
                            <div class="card-body text-right" dir="rtl">  <?php echo $__env->yieldContent('page'); ?>  </div>
                        </div>
                    </div>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright AfrangArt Design Studio <strong>TISS &copy; <?php echo e(date('Y')); ?> Market Ver 4.0</strong> </span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
