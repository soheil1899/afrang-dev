<template>
    <div>
        ...
        <div dir="ltr" class="top-contact text-center shadow-sm" style="background-color: #deeaf3; height: 400px">
            <h3 class="contact-title"
                style="font-family: Rambla; text-shadow: 0 0 1px; font-weight: bold; color: #333; padding-top: 50px; font-size: 50px">
                Contact Us
            </h3>
            <label style="color: #333; text-shadow: 0 0 1px; font-size: 18px; font-family: Rambla">
                        ...
                        <form action="" method="post">
                            <div class="row">
                                <div class="col-12 col-md-6 px-2 ">
                                    <input type="text" placeholder="Full Name" class="form-control form-control-sm mb-3">
                                </div>
                                <div class="col-12 col-md-6 px-2 ">
                                    <input type="email" placeholder="Email Address" class="form-control form-control-sm mb-3">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 col-md-6 px-2 ">
                            ...
                            <div class="row mb-5">
                                <div class="px-2 col-12">
                                    <textarea class="form-control form-control-sm" placeholder="Your Message ..." rows="5"></textarea>
                                </div>
                            </div>
