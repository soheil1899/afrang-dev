...
<div id="wrapper" dir="rtl">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion text-center"
	...
	z M38,23.9c0-7.8-6.3-14.1-14.1-14.1S9.8,16.1,9.8,23.9S16.1,38,23.9,38S38,31.7,38,23.9z"/>
            ...
            <div class="sidebar-brand-text mx-3">TISS VIDEO <sup>1.0</sup></div>
        </a>
...
<script src="/js/videocenter.js"></script>
